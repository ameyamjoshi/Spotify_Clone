    ...
    <div className='songbarContainer'>
      {props.url != null ? (
          ...
          <div
            ...
            <div className='playButton'>
              {props.imgurl.url !== null ? (
                <img src={props.imgurl.url} className='songImage1' alt="SongImage"/>
              ) : (
                <img
            ...
            <div className='time'> {Math.round((props.time / 1000)  / 60)}:{Math.round((props.time / 1000) % 60)}</div>
        ...
        <>
          ...
          {Math.round((props.time / 1000)  / 60)}:{Math.round((props.time / 1000) % 60)}
          </div>
        </>
      )}
    </div>
